    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-center sm:pt-0">
                <img src="{{ asset('assets/logo.png') }}" alt="" height="100px">
            </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            <div class="ml-4 text-lg leading-7 font-semibold"><span
                                    style="font-weight: bolder; color: white; text-transform:uppercase">
                                    <center>
                                        Login
                                    </center>
                                </span></div>
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        ...
                        <a href="https://meritsystems.co.ke" class="ml-1 underline">
                            Developed By Merit Systems
                        </a>
                    </div>
                </div>
